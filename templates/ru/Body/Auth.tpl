    ...
    <div class="wrapper">
          ...
          <li ><a href="/" class="glitch-link" data-text="Главная">Главная</a></li>
              ...
              <div class="check-in fadeInUp wow" data-wow-delay="0.2s">
                      ...
                      <div class="form">
                        ...
                        <div>
                          <div class="field-form" id="password">
                            ...
                            <!-- <span class="error-txt-input error_auth"></span> -->
                          </div>
                          
                        </div>

                        <span class="error-txt-input error_auth" style="display: block;"></span>
                      </div>
                    </div>
                ...
                <div class="nav-check-in">
                  ...
                  <div class="swiper-button-next next-check-in-step" >
                    <span class="glitch-link js_auth"  data-text="Войти">Войти</span>
                  </div>

                </div>
                <div style="margin-top: 30px;" class="swiper-button-next next-check-in-step" >
                    <!-- <span class="glitch-link js_auth"  data-text="Войти">Получить пароль на почту</span> -->
                    <a style="text-decoration: underline;" href="/get-password/">Получить пароль на почту</a>
                  </div>
              </div>
      ...
      <script type="text/javascript">
        ...
        $('.js_auth').click(function(e){ 
         ...
         $.post( "/au.php", { email:email,password:password }, function( data ) {
           console.log('data');
           $('.error_auth').empty();
           console.log(data);
           if(data.result=='0'){
            LoaderHide();
            if(data.err!='') {
             $(".field-form#auth> span.tp-input").addClass('error-input'); 
             $('.error_auth').text(data.err);
           }
         }
         else{
          LoaderHide();
