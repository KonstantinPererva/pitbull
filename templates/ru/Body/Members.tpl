	...
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TSJP4H"
           ...
           <div class="slider-round fadeInUp wow" data-wow-delay="0.2s">
             <div class="swiper-container swiper-round">
              <div class="swiper-wrapper">
               <div class="swiper-slide ">
                <div  class="round-top">
                 <!-- <div class="round-number">{$round.name}</div> -->
                 <!-- <center> -->
                  <div class="round-number">
                    {if $round.number>1}
                  <a style="margin-left: 0" href="/members-otbor{$round.number-1}/"><img src="/public/img/arr_l.png"></a>
                  
                  {/if}
                  <span>{$round.name}</span>
                  <!-- <span style="color: #ffffff; font-size: 40px; margin-left: 25px; margin-right: 25px;">{$page}</span> -->
                  {if $round.number<'2'}
                  <a  href="/members-otbor{$round.number+1}/"><img src="/public/img/arr_r.png"></a>
                  {/if}
                  </div>
      ...
      initialSlide: 1
        ...
        $('.search_button').click(function(){
         ...
         window.location.href=window.location.pathname+"?nickname="+seach_nickname;
       })
      });
