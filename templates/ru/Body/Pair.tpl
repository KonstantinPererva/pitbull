...
<header class="header">
    ...
    <div class="tournament-info">
                ...
                <div class="tournament-btn">
                   <a href="/" class="btn">{$country_title} </a>
                </div>     
 ...
 {foreach from=$pairs key=key item=pair}

 
                <div class="tournament-section">
                {if $pair.mark_sum_1>$pair.mark_sum_2}
                <div class="tournament-item top pink" style="background-image: url(/images/texture/pitbull_cover.png);">
                {else}
  ...
  {/if}
                    <div class="artist">{$pair.nickname_1}</div>
                         <a  href="javascript:void(0)" data-user-id={$pair.user_1} data-rounds="{$rounds}" class="hover  js_first_track_popup">
                    ...
                    <div class="vs">vs</div>
                    {if $pair.mark_sum_2>$pair.mark_sum_1}
                <div class="tournament-item bottom pink" style="background-image: url(/images/texture/pitbull_cover.png);">
                {else}
                    <div class="tournament-item bottom" style="background-image: url(/images/texture/pitbull_cover.png);">
  {/if}
                        <div class="artist">{$pair.nickname_2}</div>
                         <a  href="javascript:void(0)" data-user-id={$pair.user_2} data-rounds="{$rounds}" class="hover  js_first_track_popup">
                            <span class="btn"><i class="icon-play-button"></i></span>
                            <span id="'.$value[u2].'" class="view"><i class="icon-eye-outline"></i>{$pair.views_2}</span>
                        </a>
                        <div class="info">
            ...
            <div class="pagination-wrapp">
                <ul class="pagination">
                    <li class="pagination-item"><a href="{$prev_page}"><i class="icon-next left"></i></a></li>
                    <li class="pagination-item active">{$current_page}</li>
                    <li class="pagination-item">...</li>
                    <li class="pagination-item"><a href="<? echo $data['audio_array']['total_column']  ?>">{$total_page}</a></li>
                    <li class="pagination-item"><a href="{$next_page}"><i class="icon-next"></i></a></li>
                </ul>
            </div>
