    ...
    <div class="wrapper">
        <div class="container">
            ...
            <div class="header fadeInUp wow" data-wow-delay="0.2s">
                ...
                <a href="main.html" target="_blank" class="logo">
                ...
                <div class="swiper-container swiper-stories">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="stories-item" data-fancybox>
                                <span class="stories-item-preview">
                                    <span class="stories-item-img">
                                        <i class="fas fa-play"></i>
                                        <img src="/public/img/main-video.png" alt="" />
                                    </span>
                                </span>
                                гига vs майти
                            </a>
            ...
            <div class="user-profile fadeInUp wow" data-wow-delay="0.2s">
                <div class="user-profile-item">
                    ...
                    <div class="user-profile-txt">
                        ...
                        <a href="#" class="vote-btn"><span class="glitch-link" data-text="голосовать">голосовать</span></a>
                    </div>
                </div>
                <div class="media-user">
                    <iframe width="100%" height="500" scrolling="no" frameborder="no" allow="autoplay" src="https://www.youtube.com/embed/Xe_Ks8SFJ18"></iframe>
                </div>
                <div class="media-user">
                    <iframe src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/401499648&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true&visual=true" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen width="100%"></iframe>
                </div>
                ...
                <div class="comments">
                    <img src="/public/img/comments.png" alt="" />
                </div>
            </div>
